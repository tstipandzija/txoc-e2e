...
public class UpdateOccupationTwice {
	...
	public void invokeBrowser(@Optional("firefox") String browser) {
		...
		try {
			...
			selectOccupationSelectEmptyAndUpdate();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void selectOccupationSelectEmptyAndUpdate() {
		...
		try {
			...
			Thread.sleep(2000);
			Select occupation0 = new Select(driver.findElement(By.id("occupation")));
			occupation0.selectByIndex(0);
