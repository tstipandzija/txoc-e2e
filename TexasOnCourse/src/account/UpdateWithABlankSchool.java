...
public class UpdateWithABlankSchool {
	...
	public void leaveEmptyDistrictAndUpdate() {
		...
		try {
			...
			String school = driver.findElement(By.xpath("/html/body/div/div/div[1]/div[2]/ul/li[2]/a")).getText();
			System.out.println("School = " + school);
			WebElement el = driver.findElement(By.xpath("/html/body/div/div/div[1]/div[2]/ul/li[2]/a"));
			JavascriptExecutor jsExec = (JavascriptExecutor) driver;
			jsExec.executeScript("arguments[0].click()", el);
			Thread.sleep(2000);

			driver.findElement(By.id("schoolInput")).clear();
