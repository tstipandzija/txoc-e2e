...
public class UpdateTwitterAndLinkendInWithASpecChar {
	...
	public void passTwitterAndLinkedInSpecChar() {
		...
		try {
			...
			String social = driver.findElement(By.xpath("/html/body/div/div/div[1]/div[2]/ul/li[3]/a")).getText();
			System.out.println("Social = " + social);
			WebElement el = driver.findElement(By.xpath("/html/body/div/div/div[1]/div[2]/ul/li[3]/a"));
			JavascriptExecutor jsExec = (JavascriptExecutor) driver;
			jsExec.executeScript("arguments[0].click()", el);
			Thread.sleep(2000);

			driver.findElement(By.id("twitter")).sendKeys("!”#$%&'()=?*ĐŽĆČŠ");
			driver.findElement(By.id("linkedIn")).sendKeys("”!#$%&'()=?*ĐŽĆČĆŠ");

			String update = driver.findElement(By.xpath(".//*[@id='updateButton']")).getText();
			System.out.println("Update = " + update);
			WebElement el1 = driver.findElement(By.xpath(".//*[@id='updateButton']"));
