...
public class CheckTheContactUsLink {
	...
	@Test
	public void loginAndClickTheContactLink() {
		...
		try {
			...
			Thread.sleep(1000);
			String contactUs = Dashboard_Page.contactUs(driver).getText();
			System.out.println("Contact Us = " + contactUs);
			Assert.assertEquals(contactUs, "Contact Us");
			Dashboard_Page.contactUs(driver).click();
			Thread.sleep(1000);
